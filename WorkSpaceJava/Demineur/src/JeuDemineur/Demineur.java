...
/**
 * Cette classe contient diff�rentes m�thodes outils correspondant � l'interface
 * utilisateur de l'application "D�mineur".
 *    
 * @author Kenzo FAHEM
...
public class Demineur {
    ...
    /** Valeur assci�e � la diffficult� par d�faut */
    public static final int DIFFICULTE_DEFAUT = 0;

    /** Valeur assci�e � la diffficult� "D�butant" */
    public static final int DIFFICULTE_DEBUTANT = 1;
    
    /** Valeur assci�e � la diffficult� "Confirm�" */
    public static final int DIFFICULTE_CONFIRME = 2;
    
    /** Valeur assci�e � la diffficult� "Expert" */
    ...
    /** Variable qui indique le nombre de zones qui ont �t� march�es sur le terrain
     * � un instant T */
    ...
    /** Variable qui mettra fin � la m�thode "jeu()" et qui fermera le jeu */
    public static boolean sortieJeu = false;
    
    /** Variable qui indique si le joueur a subi un arr�t de jeu forc� d� � une bombe */
    public static boolean gameOver = false;
    
    /** Variable qui indique si le joueur a gagn� le jeu */
    public static boolean victoire = false;

    /** Affiche la grille � l'instant T du jeu */
    ...
    /** Affiche les diff�rentes options de saisie pour le choix de la difficult� */
    public static void afficherMenuDifficultee() {
        System.out.print(MENU_CHOIX_DIFFICULTE);
    }

    /**
     * Affiche les diff�rentes options de jeu
     */
    ...
    /** Affiche le menu D�mineur et redirige l'utilisateur selon son choix */
    ...
    public static void jeu(int noDifficulte) {
        ...
        /* Lancement du Jeu D�mineur (fin du jeu lorsque la console re�oie gameOver) */
        do {
            afficherGrille();
            menuChoixJeu();
     ...
     * Le jeu se ferme lorsque le joueur d�cide de quitter l'application
